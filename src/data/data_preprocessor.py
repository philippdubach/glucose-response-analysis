...
class HallDataPreprocessor:
    ...
    def filter_subjects(self, df_hall: pd.DataFrame, df_meals: pd.DataFrame) -> pd.DataFrame:
    ...
    def preprocess_all(self, df_hall: pd.DataFrame, df_meals: pd.DataFrame) -> pd.DataFrame:
